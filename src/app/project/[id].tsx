...
export default function ProjectDetailsScreen() {
  ...
  return (
    <>
      {/* ── Hero ── */}
      <View className="p-5 bg-primary/20 border-b border-l border-r border-primary/30 rounded-r-3xl rounded-l-3xl  flex-row items-center justify-between pb-6">
        <TouchableOpacity
        ...
        <View className="flex-row items-center gap-4">
          ...
          <View>
            {client && (
              <Text className="text-foreground text-sm mt-0.5">
                {client.full_name}
                </Text>
            )}
          </View>
