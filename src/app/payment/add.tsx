...
export default function AddPaymentScreen() {
  ...
  return (
    <>
      <View className="p-4 bg-primary/20 border-b border-l border-r border-primary/30 rounded-r-3xl rounded-l-3xl pt-4 pb-6 flex-row items-center justify-between gap-3">
        <TouchableOpacity className="flex-row my-4 items-center gap-1.5" onPress={() => router.back()} activeOpacity={0.7}>
